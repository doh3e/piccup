...
VALUES
    ...
    (1, '2023-12-03 08:45:00'),
    (2, '2023-12-04 14:20:00');
...
VALUES
(1, 'John Doe', '1990-01-01', '남', 'john.doe@example.com', '02-1234-5678', '010-1234-5678', '서울시 강남구', '101동 202호', 12345, '학사', '', '', '독서', '소프트웨어 개발'),
(2, 'Jane Doe', '1992-05-15', '여', 'jane.doe@example.com', '02-9876-5432', '010-9876-5432', '서울시 서초구', '202동 303호', 54321, '석사', '', '', '여행', '데이터 분석'),
(3, 'Smith Lee', '1985-09-20', '남', 'smith.lee@example.com', '031-5678-1234', '010-5678-1234', '경기도 성남시', '303동 404호', 34567, '박사', '', '', '음악 감상', 'AI 연구'),
(4, 'Emma Wang', '1993-11-11', '여', 'emma.wang@example.com', '031-4321-8765', '010-4321-8765', '서울시 송파구', '404동 505호', 98765, '학사', '', '', '요리', '그래픽 디자인');
...
VALUES	(1, 'TechCorp', 'Engineering', '2018-01-01', '2021-12-31', FALSE, 'Software Engineer', 80000, 'Developed enterprise software solutions.', 'exp_techcorp.pdf', '/files/techcorp'),
		(1, 'BizSolutions', 'Sales', '2019-05-15', '2020-12-31', FALSE, 'Sales Manager', 70000, 'Managed key client accounts.', 'exp_bizsolutions.pdf', '/files/bizsolutions'),
		(1, 'GreenIndustries', 'Operations', '2020-06-01', '2021-12-31', FALSE, 'Operations Manager', 85000, 'Streamlined operational processes.', 'exp_green.pdf', '/files/green'),
		(1, 'GreenIndustries', 'Operations', '2021-01-01', NULL, TRUE, 'Operations Manager', 90000, 'Managed a team of 15.', 'exp_green_2.pdf', '/files/green'),
		(1, 'HealthPlus', 'HR', '2017-03-10', '2019-02-28', FALSE, 'HR Specialist', 60000, 'Oversaw recruitment and onboarding.', 'exp_healthplus.pdf', '/files/healthplus'),
		(1, 'EduSmart', 'Teaching', '2015-08-20', '2018-06-30', FALSE, 'Teacher', 50000, 'Taught high school math.', 'exp_edusmart.pdf', '/files/edusmart'),
		(1, 'EduSmart', 'Teaching', '2019-09-01', NULL, TRUE, 'Head of Department', 65000, 'Led the department to win awards.', 'exp_edusmart_hod.pdf', '/files/edusmart'),
		(1, 'FinanceWorld', 'Investment', '2022-04-15', NULL, TRUE, 'Analyst', 75000, 'Analyzed market trends.', 'exp_financeworld.pdf', '/files/financeworld'),
		(1, 'LogiTech', 'Logistics', '2016-07-07', '2019-06-30', FALSE, 'Logistics Coordinator', 55000, 'Coordinated supply chain activities.', 'exp_logitech.pdf', '/files/logitech'),
...
VALUES	(1, TRUE, FALSE, TRUE, '중증', '군필', TRUE),
		(1, FALSE, FALSE, FALSE, '해당없음', '미필', TRUE),
		(1, FALSE, TRUE, FALSE, '해당없음', '면제', FALSE),
		(1, FALSE, FALSE, TRUE, '경증', '비대상', TRUE),
		(1, TRUE, TRUE, TRUE, '1급', '군필', TRUE),
		(1, FALSE, FALSE, FALSE, '해당없음', '해당없음', FALSE),
		(1, FALSE, TRUE, TRUE, '3급', '면제', TRUE),
		(1, TRUE, FALSE, FALSE, '5급', '군필', TRUE),
		(1, FALSE, FALSE, TRUE, '6급', '미필', FALSE),
		(1, TRUE, TRUE, TRUE, '2급', '비대상', TRUE);
...
VALUES	(1, '대학교(4년)', '서울대학교', '컴퓨터공학', '2015-03-01', '2019-02-28', '졸업', FALSE, 3.80, 3.90, 4.30, TRUE, 2019, 'transcript1.pdf', '/documents/transcripts/transcript1.pdf'),
		...
		(1, '대학교(4년)', '연세대학교', '경영학', '2018-03-01', NULL, '졸업예정', FALSE, 3.20, 3.40, 4.30, FALSE, NULL, 'transcript4.pdf', '/documents/transcripts/transcript4.pdf'),
		(2, '고등학교', '부산고등학교', NULL, '2010-03-01', '2013-02-28', '졸업', FALSE, NULL, NULL, NULL, FALSE, NULL, NULL, NULL),
		(3, '대학(2,3년)', '광주과학기술원', '정보통신', '2019-03-01', NULL, '재학 중', FALSE, 3.85, 3.90, 4.50, FALSE, NULL, 'transcript5.pdf', '/documents/transcripts/transcript5.pdf'),
		(4, '대학교(4년)', '한국외국어대학교', '국제관계학', '2014-03-01', '2018-02-28', '졸업', FALSE, 3.60, 3.70, 4.50, TRUE, 2018, 'transcript6.pdf', '/documents/transcripts/transcript6.pdf'),
		(1, '대학교(4년)', '한양대학교', '건축학', '2017-03-01', NULL, '졸업예정', FALSE, 3.40, 3.50, 4.30, FALSE, NULL, 'transcript7.pdf', '/documents/transcripts/transcript7.pdf'),
		(2, '대학원', '포항공과대학교', '화학공학', '2021-09-01', NULL, '재학 중', TRUE, 3.75, 3.80, 4.30, TRUE, NULL, 'transcript8.pdf', '/documents/transcripts/transcript8.pdf'),
		(3, '대학교(4년)', '중앙대학교', '에너지시스템공학부', '2018-03-01', '2022-02-28', '졸업', FALSE, 3.80, 3.85, 4.50, TRUE, 2022, 'transcript12.pdf', '/documents/transcripts/transcript12.pdf'),
		(4, '대학교(4년)', '중앙대학교', '전기전자공학부', '2019-03-01', NULL, '졸업예정', FALSE, 3.70, 3.75, 4.30, FALSE, NULL, 'transcript13.pdf', '/documents/transcripts/transcript13.pdf'),
		(1, '대학원', '중앙대학교', '에너지환경공학', '2021-09-01', NULL, '재학 중', FALSE, 3.85, 3.90, 4.30, TRUE, NULL, 'transcript14.pdf', '/documents/transcripts/transcript14.pdf');