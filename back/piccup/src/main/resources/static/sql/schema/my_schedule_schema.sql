...
--
-- Table structure for table `my_schedule`
--
...
--
-- Dumping data for table `my_schedule`
--

LOCK TABLES `my_schedule` WRITE;
/*!40000 ALTER TABLE `my_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `my_schedule` ENABLE KEYS */;
UNLOCK TABLES;
