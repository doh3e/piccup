...
--
-- Table structure for table `apply_schedule`
--
...
--
-- Dumping data for table `apply_schedule`
--

LOCK TABLES `apply_schedule` WRITE;
/*!40000 ALTER TABLE `apply_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `apply_schedule` ENABLE KEYS */;
UNLOCK TABLES;
