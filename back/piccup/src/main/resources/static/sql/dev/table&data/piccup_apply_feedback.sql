...
--
-- Table structure for table `apply_feedback`
--
...
--
-- Dumping data for table `apply_feedback`
--

LOCK TABLES `apply_feedback` WRITE;
/*!40000 ALTER TABLE `apply_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `apply_feedback` ENABLE KEYS */;
UNLOCK TABLES;
